...
| 最新 | 2026-03-28 | 🚀 大演进 | **插件自动安装与更新系统**（PluginInstaller + PluginUpdateNotifier：真实插件下载/解压/安装/验证/卸载引擎 + 更新检测与通知生成，新增 6 个 API 端点，52 个单元测试全通过，从「有市场原型」到「有完整插件生态」的维度跃迁，Stage 4 → Stage 5 平台化里程碑） | Stage 4 → 5 过渡（平台化里程碑） |
