...
ensureData().then(async () => {
  ...
  workloadAlerts.startWorkloadAlertScheduler();
  const workloadConfig = await workloadAlerts.getWorkloadAlertsConfig();
...
// Workload alerts module has been extracted to lib/workload-alerts.js
